...
{
    public partial class perDay : ContentPage
    {
        ...
        private double TotalIncome()
        {
            ...
            foreach (var item in list.Where(
                x => x.Date.Date == selectedDate && x.Type == "Green"))
            {
        ...
        private double TotalExpenses()
        {
            ...
            foreach (var item in list.Where(
                x => x.Date.Date == selectedDate && x.Type == "Red"))
            {
        ...
        {
            var selectedDate = datePicker.Date;
            var filteredList = list.Where(x => x.Date.Date == selectedDate).ToList();
