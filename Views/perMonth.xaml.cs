...
public partial class perMonth : ContentPage
{
    ...
    private double TotalIncome()
    {
        ...
        foreach (var item in list.Where(
            x => x.Date.Month == selectedDate.Month && x.Date.Year == selectedDate.Year && x.Type == "Green"))
        {
    ...
    private double TotalExpenses()
    {
        ...
        foreach (var item in list.Where(
            x => x.Date.Month == selectedDate.Month && x.Date.Year == selectedDate.Year && x.Type == "Red"))
        {
    ...
    {
        var selectedDate = datePicker.Date;
        var filteredList = list.Where(x => x.Date.Month == selectedDate.Month && x.Date.Year == selectedDate.Year).ToList();
